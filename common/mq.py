...
class RabbitMQEventBroker:
    ...
    def _connect(self):
        ...
        try:
            connection_params = pika.ConnectionParameters(
                host=self.host, port=self.port, credentials=self.credentials, heartbeat=600, blocked_connection_timeout=300
            )
    ...
    def consume(self, queue_name: str, callback: Callable[[Any, Any, Any, bytes], None], auto_ack: bool = False):
        """
