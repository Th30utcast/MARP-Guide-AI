...
from ingestion_service import MARPScraper, PDFFetcher, IngestionService
...
class TestIngestionService:
    ...
    def test_extract_document_id_from_url(self):
        ...
        doc_id = service._extract_document_id_from_url(
            "https://example.com/docs/Academic-Appeals.pdf"
        )
        assert doc_id == "Academic-Appeals"

        doc_id = service._extract_document_id_from_url(
            "https://example.com/General-Regs.pdf"
        )
    ...
    def test_run_ingestion_success(self, mock_discover, mock_process):
        ...
        mock_discover.return_value = [
            {"title": "Test PDF", "url": "https://example.com/test.pdf"}
        ]
